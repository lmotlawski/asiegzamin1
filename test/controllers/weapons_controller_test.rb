...
class WeaponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weapon" do
    assert_difference('Weapon.count') do
      post weapons_url, params: { weapon: { caliber: @weapon.caliber, category_id: @weapon.category_id, description: @weapon.description, name: @weapon.name } }
    end
  ...
  test "should update weapon" do
    patch weapon_url(@weapon), params: { weapon: { caliber: @weapon.caliber, category_id: @weapon.category_id, description: @weapon.description, name: @weapon.name } }
